...
def main():
    ...
    parser.add_argument('--trials', default=12, type=int, help='Number of Trials to Execute')
    parser.add_argument('--warmup-trials', default=3, type=int, help='Warmup Trials to discard')
