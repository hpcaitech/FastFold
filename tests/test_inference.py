...
def get_openfold_module_and_output():
...
def test_state_dict(world_size, chunk_size, inplace, get_openfold_module_and_output):
    run_func = partial(run_dist, world_size=world_size, chunk_size=chunk_size, inplace=inplace, model=get_openfold_module_and_output)
...
def inference(chunk_size, inplace, get_openfold_module_and_output):

    model, out = get_openfold_module_and_output
