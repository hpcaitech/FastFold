...
def test_state_dict(world_size, chunk_size, inplace):
    ...
    run_func = partial(_test_extramsa_stack, world_size=world_size, chunk_size=chunk_size, inplace=inplace, 
                       target_module=target_module, fast_module=fast_module, config=config)
    mp.spawn(run_func, nprocs=world_size)


def _test_extramsa_stack(rank, world_size, chunk_size, inplace, target_module, fast_module, config):
